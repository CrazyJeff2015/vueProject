  ...
  <span class="el-dropdown-link">
    选择<i class="el-icon-caret-bottom el-icon--right"></i>
              ...
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item :command="'1#'+scope.row.id+'#'+scope.row.role+'#'+scope.row.role_type">更改角色</el-dropdown-item>
      ...
      <el-form :model="addInfo" :rules="rules" ref="addInfo" label-width="100px">
        ...
        <el-form-item label="角色" prop="role_id" required>
          <el-checkbox-group v-model="addInfo.role_id">
            <el-checkbox-button v-for="item in roleList" :label="item.id" :key="item.id">{{item.name}}</el-checkbox-button>
          </el-checkbox-group>
        </el-form-item>
      </el-form>
