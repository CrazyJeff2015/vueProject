  ...
  <el-card class="box-card">
    <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
      <el-form-item label="会员账号">
        <el-input v-model="searchInfo.gaccount" placeholder="精确查询"></el-input>
      </el-form-item>
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template scope="scope">
          <span v-text="-1*Number(scope.row.realCommision)"></span>
        </template>
      </el-table-column>
      <el-table-column
        prop="created_at"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getData(val) {
        this.Data.pageApi = api.soleCommissions + '?page=' + (val ? val : this.Data.pageCurrent) + '&limit=' + this.Data.pagesize + this.parseParam(this.searchInfo);
        this.dataHandle();
      },
      getSize(val) {

        this.Data.pageApi = api.soleCommissions + '?page=' + this.Data.pageCurrent + '&limit=' + (val ? val : this.Data.pagesize) + this.parseParam(this.searchInfo);
        //搜索结束
        this.dataHandle();
      },
      dataHandle(){
