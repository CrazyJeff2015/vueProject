  ...
  <div>
    <el-card class="box-card">
      ...
      <el-table
        ...
        <el-table-column prop="success_cash" label="总金币变化">
        </el-table-column>
        <el-table-column prop="is_on" label="状态">
        </el-table-column>
        <el-table-column label="操作">
          <template scope="scope">
            <el-button size="mini" v-if="permissions.donation_amount"  @click="showSentFn(scope.row.gaccount)">赠送金币</el-button>
            <el-button size="mini" v-if="permissions.view_customer_consume"   @click="showCashFn(scope.row.customerId)">佣金记录</el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
    ...
    <el-dialog title="赠送金币" :visible.sync="showSent" :show-close="false">
      <solo_withdrawals1 :gaccount="sentNickName" ></solo_withdrawals1>
      <div slot="footer" class="dialog-footer">
        <el-button @click="showSent = false;">关 闭</el-button>
      </div>
    </el-dialog>
    <el-dialog title="佣金记录" size="large" :visible.sync="showCash" :show-close="false">
      <el-table
        ...
        <el-table-column prop="gaccount" label="会员ID">
        </el-table-column>
...
<script>
  ...
  import solo_withdrawals1 from "./solo_withdrawals1";
  export default {
    name: "customers",
    components:{
      solo_withdrawals1,
