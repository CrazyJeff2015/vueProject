  ...
  <div>
    <el-card class="box-card">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
        ...
        <el-form-item>
          <el-button>
            <router-link to="/user/solo_set_agent">
              <a class="logo">开设独家代理</a>
            </router-link>
          </el-button>
        </el-form-item>
      </el-form>
      <el-table
        ...
        <el-table-column sortable="custom"  label="分成比例">
          <template scope="scope">
        ...
        <el-table-column prop="agent_name" label="登陆账号">
        </el-table-column>
        <el-table-column prop="created_at" label="注册时间">
        </el-table-column>
        <el-table-column  prop="agent_num" label="推广代理/玩家数">
          <template scope="scope">
            <span v-text="scope.row.agent_num"></span>/<span v-text="scope.row.gaccount_num"></span>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="beforeCashCount" label="上周金币变化">
        </el-table-column>
        <el-table-column prop="nowCashCount" label="本周金币变化">
        </el-table-column>
        <el-table-column prop="beforeCommission" label="上周收益">
        </el-table-column>
        <el-table-column prop="nowCommission" label="本周收益">
        </el-table-column>
  ...
  <span class="el-dropdown-link">
    选择<i class="el-icon-caret-bottom el-icon--right"></i>
              ...
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item :command="'3#'+scope.row.id">设置密码</el-dropdown-item>
                <!--<el-dropdown-item :command="'5#'+scope.row.id">佣金操作</el-dropdown-item>-->
                <el-dropdown-item :command="'6#'+scope.row.id+'#'+scope.row.agent_name">查看会员</el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
          </template>
        </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      getData(val) {
        ...
        this.Data.pageApi = api.adminSIndex + '?page=' + (val ? val : this.Data.pageCurrent) + '&limit=' + this.Data.pagesize  + this.parseParam(this.searchInfo);
        this.dataHandle();
      },
      getSize(val) {

        this.Data.pageApi = api.adminSIndex + '?page=' + this.Data.pageCurrent + '&limit=' + (val ? val : this.Data.pagesize)  + this.parseParam(this.searchInfo);
        //搜索结束
        this.dataHandle();
      },
      dataHandle(){
