<template>
  <div>
    <el-card class="box-card">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h4 class="r_money">代理可转出金额:<span v-text="loginScore"></span>(金额)
            <el-button :plain="true" type="danger" size="small" @click="allGive()">全部转出</el-button>
            <el-button v-show="permissions.score_transform" :plain="true" type="danger" size="small" @click="showChange=true">转入代运营金币</el-button>
          </h4>
          <el-row>
            <el-col :span="12">
      ...
      <el-dialog title="转入代运营金币" :visible.sync="showChange" :show-close="false">
        <el-form :model="changeData" ref="changeData" :rules="changeRule" label-width="150px">
          <el-form-item label="当前可用金额:">
            <span v-text="loginScore" style="color: red"></span>
          </el-form-item>
