      ...
      <el-table
        ...
        <el-table-column
          ...
          <template scope="scope">
            <span>{{scope.row.type}}</span>/<span>{{scope.row.is_child}}</span>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
...
<script>
  ...
  export default {
    ...
    methods: {
      getData(val) {
        this.Data.pageApi = api.log + '?page=' + (val ? val : this.Data.pageCurrent) + '&limit=' + this.Data.pagesize + this.parseParam(this.searchInfo);
        this.dataHandle();
      },
      getSize(val) {

        this.Data.pageApi = api.log + '?page=' + this.Data.pageCurrent + '&limit=' + (val ? val : this.Data.pagesize) + this.parseParam(this.searchInfo);
        //搜索结束
        this.dataHandle();
      },
      dataHandle(){
