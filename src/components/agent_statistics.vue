  ...
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-table :data="Data.data" border style="width: 100%; margin-top: 20px" @sort-change="sortHandle">
        <el-table-column prop="agent_aname" label="代理号">
          <template scope="scope">
            <a href="#" v-text="scope.row.agent_aname"
               @click.prevent="enterIndexAgent(scope.row.agent_id,scope.row.agent_aname)" v-if="scope.row.nextAgent==1"></a>
        ...
        <el-table-column prop="commission" label="自身佣金">
        </el-table-column>
        <el-table-column prop="nextCommission" label="下级总佣金">
        </el-table-column>
        <el-table-column prop="allCashCount" label="所有会员总输赢">
        </el-table-column>
        <el-table-column prop="cashCount" label="直接会员总输赢">
        </el-table-column>
        <el-table-column prop="nextCashCount" label="间接会员总输赢">
        </el-table-column>
      ...
      <el-table :data="countData.data" border :show-header="false">
        ...
        <el-table-column prop="commissionCount">
        </el-table-column>
        <el-table-column prop="commission">
        </el-table-column>
        <el-table-column prop="nextCommission">
        </el-table-column>
        <el-table-column prop="allCashCount">
        </el-table-column>
        <el-table-column prop="cashCount">
        </el-table-column>
        <el-table-column prop="nextCashCount">
        </el-table-column>
