  ...
  <div>
    ...
    <el-card class="box-card">
      ...
      <div style="margin-bottom: 20px">
        <el-button type="danger" icon="delete" size="small" v-if="permissions.delete_cname" @click="deleteConfirm()">删除选择</el-button>
        <el-button type="primary" size="small" v-if="permissions.create_cname" @click="showAdd=true"><i class="el-icon-plus" ></i> 新增域名</el-button>
      </div>
        ...
        <el-table-column label="操作">
          <template scope="scope">
            <button
              ...
              @click="handleEdit(scope.$index, scope.row)" v-if="permissions.edit_cname"> <i class="el-icon-edit"></i></button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
...
<script>
  ...
  import url from './smallCom/urlManager.vue';
  import oUrl from  './oUrl_manage.vue'
  export default {
    name: "name_charge",
    components: {url,oUrl},
    data: function(){
