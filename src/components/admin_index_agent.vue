  ...
  <span class="el-dropdown-link">
    选择<i class="el-icon-caret-bottom el-icon--right"></i>
              ...
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item v-if="permissions.next_agent_admin_pwd" :command="'3#'+scope.row.id">设置密码
                </el-dropdown-item>
  ...
  export default {
    ...
    methods: {
      ...
      getData(val) {
        ...
        this.Data.pageApi = api.sAdminNextAgent + '?page=' + (val ? val : this.Data.pageCurrent) + '&limit=' + this.Data.pagesize + this.parseParam(this.searchInfo);
        this.dataHandle();
      },
      getSize(val) {

        this.Data.pageApi = api.sAdminNextAgent + '?page=' + this.Data.pageCurrent + '&limit=' + (val ? val : this.Data.pagesize) + this.parseParam(this.searchInfo);
        //搜索结束
        this.dataHandle();
      },
      dataHandle(){
