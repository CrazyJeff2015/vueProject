    ...
    methods: {
      ...
      getData(val) {
        ...
        for(var k in this.searchInfo){
          ...
          this.Data.pageApi = api.operWithList + '?page=' + (val ? val : this.Data.pageCurrent) + '&limit=10' + this.parseParam(this.searchInfo);
      ...
      getSize(val) {
          ...
          this.Data.pageApi = api.operWithList + '?page=' + this.Data.pageCurrent + '&limit=' + (val ? val : this.Data.pagesize) + this.parseParam(this.searchInfo);
        //搜索结束
        this.dataHandle();
      },
      dataHandle(){
        ...
        this.$ajax.get(this.Data.pageApi)
          .then(function (response) {
            ...
            _this.currentTotal = Number(response.data.meta.pagination.total);
