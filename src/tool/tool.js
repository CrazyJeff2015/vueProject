...
exports.install = function (Vue, options) {
   // 保存cookie
  Vue.prototype.saveCookie = function (value,time){
    $(document).ready(function() {
      //console.log("cookie saving");
      var expiresDate = new Date();
      expiresDate.setTime(expiresDate.getTime() + (time));
      $.cookie('87info', value, { expires: expiresDate });
    })
  };

  Vue.prototype.dataFormat = function (date,fmt) {
    var o = {
  ...
  Vue.prototype.unserialize = function (str) {
    var res = {};
    if(!str){
      return res;
    }
